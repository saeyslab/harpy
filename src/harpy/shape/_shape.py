...
def prep_region_annotations(
    ...
    """
    Prepares region annotations in a shapes layer for `hp.sh.morphological_features`, `hp.tb.assign_cells_to_shapes` and `hp.tb.compute_distance_to_shapes`.
    Operations performed:
        ...
        - Shift indices by +1 if index 0 is present (index 0 is reserved for background in labels layers).
