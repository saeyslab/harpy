...
def compute_distance_to_shapes(
    ...
    if has_polygons:
        ...
        if "nearest_edge" in modes:
            print(f"Calculating 'nearest_edge' distances'")
        ...
        if "nearest_edge_grouped" in modes:
            print(f"Calculating 'nearest_edge_grouped' distances'")
        ...
        if "all_edges" in modes:
            print(f"Calculating 'all_edges' distances'")
        ...
        if "nearest_outer_edge" in modes:
            print(f"Calculating 'nearest_outer_edge' distances'")
            joined = gpd.sjoin_nearest(
                pts_gdf, 
                ext_gdf,
                how="left", distance_col="dist"
        ...
        if "nearest_outer_edge_grouped" in modes:
            print(f"Calculating 'nearest_outer_edge_grouped' distances'")
            for name, group in gdf_polygons.groupby(shape_names_column):
                edges = []
                labels = []
                for idx, row in group.iterrows():
        ...
        if "all_outer_edges" in modes:
            print(f"Calculating 'all_outer_edges' distances'")
            for _, feat in gdf_polygons.reset_index(drop=True).iterrows():
        ...
        if "nearest_inner_edge" in modes and not holes_gdf.empty:
            print(f"Calculating 'nearest_inner_edge' distances'")
            joined = gpd.sjoin_nearest(
                pts_gdf, 
                holes_gdf,
                how="left", 
        ...
        if "nearest_inner_edge_grouped" in modes:
            print(f"Calculating 'nearest_inner_edge_grouped' distances'")
            for name, group in gdf_polygons.groupby(shape_names_column):
                hole_lines = []
                hole_labels = []
        ...
        if "nearest_inner_edge_grouped_unique" in modes:
            print(f"Calculating 'nearest_inner_edge_grouped_unique' distances'")
        ...
        if "all_inner_edges" in modes and not holes_gdf.empty:
            print(f"Calculating 'all_inner_edges' distances'")
        ...
        if "nearest_centroid" in modes:
            print(f"Calculating 'nearest_centroid' distances'")
            joined = gpd.sjoin_nearest(
        ...
        if "nearest_centroid_grouped" in modes:
            print(f"Calculating 'nearest_centroid_grouped' distances'")
            for name, group in gdf_polygons.groupby(shape_names_column):
        ...
        if "all_centroids" in modes:
            print(f"Calculating 'all_centroids' distances'")
    ...
    if has_points:
        if "nearest_point" in modes:
            print(f"Calculating 'nearest_point' distances'")
            joined = gpd.sjoin_nearest(
        ...
        if "nearest_point_grouped" in modes:
            print(f"Calculating 'nearest_point_grouped' distances'")
        ...
        if "all_points" in modes:
            print(f"Calculating 'all_points' distances'")
