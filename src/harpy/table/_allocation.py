...
def bin_counts(
    ...
    labels_name
        The labels layer (e.g., segmentation mask, or a grid generated by :func:`harpy.im.add_grid_labels_layer`) in `sdata` used to bin barcodes (as specified via `table_name`) into cells or regions.
    output_table_name
